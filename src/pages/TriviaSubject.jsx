/**
 * TriviaSubject.jsx - TRIVIA MODE (Per Disciplină)
 *
 * Întrebări RANDOM din TOATE tematicile unei discipline
...
import { saveQuizSession, updateUserStats, getSubjectTriviaQuestions, getUserStats } from '../services/quizService';
...
/**
 * EFFECT: Load SUBJECT TRIVIA questions from Firestore
 */
useEffect(() => {
...
const finishQuiz = async () => {
  ...
  try {
    ...
    const sessionData = {
      ...
      themeId: `trivia-${subjectSlug}`, // Special ID for trivia per subject
      ...
      mode: 'trivia-subject' // Flag pentru trivia mode
    };
      ...
      <div className="min-h-screen bg-off-white flex items-center justify-center p-4 sm:p-8">
        <div className="bg-cream border-6 border-error p-6 sm:p-8 max-w-md w-full">
          ...
          <p className="font-body text-deep-brown mb-6 text-base">
            Nu am găsit întrebări pentru această disciplină și dificultate.
          </p>
          <button
      ...
      <div className="min-h-screen bg-off-white flex items-center justify-center p-4 sm:p-8">
        <div className="bg-cream border-6 border-deep-brown p-6 sm:p-8 md:p-12 max-w-2xl w-full">
          ...
          <div className="text-center mb-6">
            <span className="inline-block bg-gradient-to-r from-neon-pink to-neon-cyan text-off-white px-4 py-2 font-heading font-black text-sm uppercase tracking-wide mb-4">
              🎲 TRIVIA {subject?.icon} {subject?.name.toUpperCase()}
            </span>
          </div>
          ...
          <div className="mb-6 sm:mb-8 text-center">
            ...
            {percentage >= 80 && percentage < 100 && (
              <p className="font-heading text-xl font-bold text-[#10B981]">
                🌟 Excelent! Cunoștințe impresionante la {subject?.name}!
              </p>
            )}
            ...
            {percentage < 60 && (
              <p className="font-heading text-xl font-bold text-neon-pink">
                📖 Mai mult de studiat! Revino la tematici și exersează!
              </p>
            )}
          </div>
            ...
            <div className="bg-sand border-4 border-warm-brown p-4 sm:p-6 mb-6 sm:mb-8">
              ...
              <div className="grid grid-cols-2 gap-3 sm:gap-4 font-body text-sm text-deep-brown">
                ...
                <div className="col-span-2 flex justify-center pt-2">
                  <StreakDisplay days={sessionStreak} size="medium" showLabel={true} />
                </div>
          ...
          <div className="bg-cream border-4 border-sand p-4 sm:p-6 mb-6 sm:mb-8 font-body text-sm text-deep-brown space-y-2">
            <p><strong>Disciplină:</strong> {subject?.name}</p>
            <p><strong>Mod:</strong> Trivia (Toate Tematicile)</p>
          ...
          <nav className="max-w-7xl mx-auto flex flex-wrap items-center justify-between gap-3 sm:gap-4">
            ...
            <div className="flex items-center gap-2 sm:gap-4">
              ...
              <div className="font-mono text-sm font-bold uppercase tracking-wider text-deep-brown">
                <span className="hidden sm:inline">🎲 {subject?.icon} {subject?.name} • </span>{difficultyInfo.emoji}
              </div>
            </div>
